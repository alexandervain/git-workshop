...
export class ResetSoftTask implements ExcerciseTask {
  ...
  public readonly afterNotes = [
    ...
    `* once done and checked - restart the excercise and try doing the reset using the sv[hash] of the commit and not the HEAD ref`,
  ];
